  ...
  switch (role) {
    case 'Faculty/Staff':
      return {
        ...
        allowedViews: ['dashboard', 'schedule', 'clash-detector', 'calendar', 'action-items', 'minutes'],
    ...
    case 'Committee Chair':
      return {
        ...
        allowedViews: ['dashboard', 'schedule', 'clash-detector', 'approvals', 'calendar', 'action-items', 'minutes', 'reports'],
    ...
    case 'Office Admin':
      return {
        ...
        canManageMoM: false,
        canAssignActionItems: true,
        allowedViews: ['dashboard', 'clash-detector', 'rooms', 'approvals', 'calendar', 'reports'],
    ...
    default:
      return {
        ...
        canAssignActionItems: true,
        allowedViews: [
          'dashboard', 'schedule', 'clash-detector', 'approvals', 'calendar', 
